...
export const pillars = [
  {id:'pride',title:'Pride & false security',ref:'1:1–9',verse:3,icon:'mountain',description:'Rocky heights, trusted allies, and human wisdom cannot protect Edom from the judgment announced by Yahweh.',question:'What makes Edom feel secure? What does the text say will happen to each source of confidence?'},
  {id:'brother',title:'Our responsibility to others',ref:'1:10–14',verse:10,icon:'people',description:'The accusation moves from standing aside to rejoicing, plundering, and handing over those who escape.',question:'Follow the actions in verses 11–14. How does indifference become participation in harm?'},
  {id:'day',title:'The day of Yahweh',ref:'1:15–16',verse:15,icon:'sun',description:'The horizon widens from Edom to all the nations. The deeds of the nations return upon their own heads.',question:'What changes when the prophecy moves from Edom to all the nations?'},
  {id:'kingdom',title:'Restoration & God’s kingdom',ref:'1:17–21',verse:21,icon:'crown',description:'The closing verses speak of escape, holiness, restored possession, and the kingdom belonging to Yahweh.',question:'Compare the mountain of Esau with Mount Zion. How does the last sentence bring the book together?'}
];
